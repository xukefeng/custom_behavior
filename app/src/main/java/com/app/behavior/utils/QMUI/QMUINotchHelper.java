...
package com.app.behavior.utils.QMUI;
...
public class QMUINotchHelper {
    ...
    public static boolean hasNotchInVivo(Context context) {
        ...
        try {
            ...
            QMUILog.i(TAG, "hasNotchInVivo ClassNotFoundException");
        } catch (Exception e) {
            QMUILog.e(TAG, "hasNotchInVivo Exception");
        }
        return ret;
    }
    ...
    public static boolean hasNotchInHuawei(Context context) {
        ...
        try {
            ...
            QMUILog.i(TAG, "hasNotchInHuawei ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            QMUILog.e(TAG, "hasNotchInHuawei NoSuchMethodException");
        } catch (Exception e) {
            QMUILog.e(TAG, "hasNotchInHuawei Exception");
        }
        return hasNotch;
    }
    ...
    public static int[] getNotchSizeInHuawei(Context context) {
        if (sNotchSizeInHawei == null) {
            ...
            try {
                ...
                QMUILog.e(TAG, "getNotchSizeInHuawei ClassNotFoundException");
            } catch (NoSuchMethodException e) {
                QMUILog.e(TAG, "getNotchSizeInHuawei NoSuchMethodException");
            } catch (Exception e) {
                QMUILog.e(TAG, "getNotchSizeInHuawei Exception");
            }
