...
public class OppoNewsHeaderPagerBehavior extends ViewOffsetBehavior {
    ...
    public OppoNewsHeaderPagerBehavior() {
        init();
    }


    public OppoNewsHeaderPagerBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
